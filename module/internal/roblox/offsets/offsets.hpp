...
const uintptr_t FireTouchInterest = REBASE(0x2572270);
} // namespace Signals
...
inline auto GetCapabilities =
    (__int64(__fastcall *)(int *))Offsets::get_capabilites;
inline auto GetIdentityStruct =
    reinterpret_cast<TGetIdentityStruct>(Offsets::Identity::GetIdentityStruct);
...
inline auto Luau_Execute =
    (void(__fastcall *)(lua_State *))Offsets::Luau::Luau_Execute;
inline auto GetLuaStateForInstance =
    (lua_State * (__fastcall *)(uint64_t, uint64_t *, uint64_t *))
        Offsets::GetLuaStateForInstance;
inline auto ScriptContextResume = (uint64_t(__fastcall *)(
    uint64_t, DebuggerResult *, WeakThreadRef **, uint32_t, uint8_t,
    uint64_t))Offsets::ScriptContextResume;

inline auto PushInstance =
    (uintptr_t *(__fastcall *)(lua_State *, uintptr_t))Offsets::PushInstance;
inline auto PushInstance2 =
    (uintptr_t *(__fastcall *)(lua_State *, std::shared_ptr<uintptr_t *>))
        Offsets::PushInstance2;

inline auto Uintptr_TPushInstance =
    (uintptr_t *(__fastcall *)(lua_State *, uintptr_t))Offsets::PushInstance;

typedef int(__fastcall *LuaVMLoad_t)(lua_State *L, std::string *bytecode,
                                     const char *chunkname, int env);
inline LuaVMLoad_t LuaVMLoad =
    reinterpret_cast<LuaVMLoad_t>(Offsets::LuaVMLoad);
...
inline auto FireProximityPrompt =
    (void(__fastcall *)(uintptr_t))Offsets::Signals::FireProximityPrompt;

inline auto FireTouchInterest =
    (void(__fastcall *)(uintptr_t, uintptr_t, uintptr_t, bool,
                        bool))Offsets::Signals::FireTouchInterest;
} // namespace Roblox